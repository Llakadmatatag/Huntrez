document.addEventListener('DOMContentLoaded', function() {
    // Set the end date for the countdown (July 31, 2025 23:59:59 UTC)
    ...
    function formatPrize(rank) {
        const prizes = [
            { amount: '500', icon: 'images/csbattle-coin.svg' },
            { amount: '250', icon: 'images/csbattle-coin.svg' },
            { amount: '100', icon: 'images/csbattle-coin.svg' },
            { amount: '50', icon: 'images/csbattle-coin.svg' },
            { amount: '50', icon: 'images/csbattle-coin.svg' },
